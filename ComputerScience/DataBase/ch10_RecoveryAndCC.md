...
![TransactionExample1](./Image/ch10/TransactionExample1.PNG)
...
![TransactionExample2](./Image/ch10/TransactionExample2.PNG)
...
![ACIDProperties](./Image/ch10/ACIDProperties.PNG)
...
![ACIDAndDBMSFunctions](./Image/ch10/ACIDAndDBMSFunctions.PNG)
...
![TransactionStates](./Image/ch10/TransactionStates.PNG)
...
![TransactionSQLExample1](./Image/ch10/TransactionSQLExample1.PNG)

#### 수행 과정

![TransactionSQLExample2ExecutionProcess](./Image/ch10/TransactionSQLExample2ExecutionProcess.PNG)
...
![FailureTypes](./Image/ch10/FailureTypes.PNG)

### 데이터베이스 저장 장치 종류

![DatabaseStorageTypes](./Image/ch10/DatabaseStorageTypes.PNG)

### 데이터 이동 연산

![DataMovementOperations](./Image/ch10/DataMovementOperations.PNG)

#### 디스크 & 메인 메모리 간 데이터 이동 연산

![InputOutputOperations](./Image/ch10/InputOutputOperations.PNG)
...
![ReadWriteOperations](./Image/ch10/ReadWriteOperations.PNG)
...
![LogFileStructure](./Image/ch10/LogFileStructure.PNG)

### 로그 기록 예시

- 계좌 잔액이 10,000원인 성호가 계좌 잔액이 0원인 은경에게 5,000원 이체

![LogFileExample](./Image/ch10/LogFileExample.PNG)

### 회복 기법

![RecoveryMethods](./Image/ch10/RecoveryMethods.PNG)
...
![ImmediateUpdateRecoveryExample](./Image/ch10/ImmediateUpdateRecoveryExample.PNG)

- 데이터베이스 회복 전략

![RecoveryStrategy](./Image/ch10/RecoveryStrategy.PNG)

- 장애 발생 시 반영 결과
  - 1에서 장애 발생 : undo($T_1$)
  - 2에서 장애 발생 : undo($T_2$), redo($T_1$)

![ImmediateUpdateRecoveryExample2](./Image/ch10/ImmediateUpdateRecoveryExample2.PNG)
...
![RecoveryStrategy2](./Image/ch10/RecoveryStrategy2.PNG)

- 장애 발생 시 반영 결과
  - 1에서 장애 발생 : 로그 기록 무시 후 별다른 회복 조치 X
  - 2에서 장애 발생 : redo($T_1$)

![DeferredUpdateRecoveryExample](./Image/ch10/DeferredUpdateRecoveryExample.PNG)
...
![CheckpointRecoveryExample](./Image/ch10/CheckpointRecoveryExample.PNG)
...
![LostUpdateExample](./Image/ch10/LostUpdateExample.PNG)

- 해결 과정
  - 트랜잭션을 순차적으로 수행해서 갱신 분실 문제 방지

![LostUpdateSolutionExample](./Image/ch10/LostUpdateSolutionExample.PNG)
...
![InconsistencyExample](./Image/ch10/InconsistencyExample.PNG)

- 해결 과정
  - 트랜잭션을 순차적으로 수행해서 모순성 문제 방지

![InconsistencySolutionExample](./Image/ch10/InconsistencySolutionExample.PNG)
...
![CascadingRollbackExample](./Image/ch10/CascadingRollbackExample.PNG)

- 해결 과정
  - 트랜잭션을 순차적으로 수행해서 연쇄 복귀 문제 방지

![CascadingRollbackSolutionExample](./Image/ch10/CascadingRollbackSolutionExample.PNG)
...
![ScheduleTypes](./Image/ch10/ScheduleTypes.PNG)
...
![SerialScheduleExample1](./Image/ch10/SerialScheduleExample1.PNG)

- 트랜잭션 $T_1$, $T_2$ 대상 두 번째 직렬 스케줄

![SerialScheduleExample2](./Image/ch10/SerialScheduleExample2.PNG)
...
![NonSerialScheduleExample1Success](./Image/ch10/NonSerialScheduleExample1Success.PNG)

- 트랜잭션 $T_1$, $T_2$ 대상 두 번째 비직렬 스케줄 : 실패

![NonSerialScheduleExample2Failure](./Image/ch10/NonSerialScheduleExample2Failure.PNG)
...
![SerializableScheduleExample](./Image/ch10/SerializableScheduleExample.PNG)
...
![TwoTransactionUpdate](./Image/ch10/TwoTransactionUpdate.PNG)
...
![TwoTransactionUpdateExample1](./Image/ch10/TwoTransactionUpdateExample1.PNG)

![TwoTransactionUpdateExample2](./Image/ch10/TwoTransactionUpdateExample2.PNG)

#### 로킹 기법 예시

![LockingTechniqueExample](./Image/ch10/LockingTechniqueExample.PNG)
...
![LockCompatibility](./Image/ch10/LockCompatibility.PNG)
...
![BasicLockingIssueExample](./Image/ch10/BasicLockingIssueExample.PNG)
...
![TwoPhaseLockingProtocolExample](./Image/ch10/TwoPhaseLockingProtocolExample.PNG)
...
![TransactionIsolationScenario](./Image/ch10/TransactionIsolationScenario.PNG)
...
![UserTableExample](./Image/ch10/UserTableExample.PNG)
...
![DirtyReadProblemExample](./Image/ch10/DirtyReadProblemExample.PNG)
...
![NonRepeatableReadProblemExample](./Image/ch10/NonRepeatableReadProblemExample.PNG)
...
![PhantomReadProblemExample](./Image/ch10/PhantomReadProblemExample.PNG)
...
![NonRepeatableReadExperiment1](./Image/ch10/NonRepeatableReadExperiment1.PNG)

#### 문제 방지 : REPEATABLE READ 모드

![NonRepeatableReadExperiment2](./Image/ch10/NonRepeatableReadExperiment2.PNG)

### 유령 데이터 읽기 문제 발생 실험

#### 문제 발생 : 유령 데이터 읽기 문제

![PhantomReadExperiment1](./Image/ch10/PhantomReadExperiment1.PNG)

#### 문제 방지 : SERIALIZABLE 모드

![PhantomReadExperiment2](./Image/ch10/PhantomReadExperiment2.PNG)
