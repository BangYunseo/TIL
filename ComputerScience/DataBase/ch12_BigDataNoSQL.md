...
![BigDataKeyTechnology](./Image/ch12/BigDataKeyTechnology.PNG)
...
![ApacheHadoop](./Image/ch12/ApacheHadoop.PNG)
...
![BigDataStorageAndNoSQL](./Image/ch12/BigDataStorageAndNoSQL.PNG)
...
![SQLVsNoSQL](./Image/ch12/SQLVsNoSQL.PNG)

### NoSQL 데이터베이스 유형

#### 1. 키-값 데이터베이스(Key-Value Database)

![KeyValueDatabase](./Image/ch12/KeyValueDatabase.PNG)
...
![DocumentDatabase](./Image/ch12/DocumentDatabase.PNG)
...
![ColumnFamilyDatabase](./Image/ch12/ColumnFamilyDatabase.PNG)
...
![GraphDatabase](./Image/ch12/GraphDatabase.PNG)
...
![ClassificationAnalysis](./Image/ch12/ClassificationAnalysis.PNG)

2. 군집(Clustering) 분석

![ClusteringAnalysis](./Image/ch12/ClusteringAnalysis.PNG)

3. 연관(Association) 분석

![AssociationAnalysis](./Image/ch12/AssociationAnalysis.PNG)

4. 예측(Forecasting) 분석

![ForecastingAnalysis](./Image/ch12/ForecastingAnalysis.PNG)
...
![BigDataVisualization](./Image/ch12/BigDataVisualization.PNG)
