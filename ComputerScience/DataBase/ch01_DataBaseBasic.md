...
| ![DataAndInformation](./Image/ch01/DataAndInformation.PNG) | - 데이터(Data) : 현실 세계에서 단순히 관찰·측정하여 수집한 사실·값<br>- 정보(Information) : 의사 결정에 유용하게 활용하는 데이터를 처리한 결과물 |
| --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
...
![InformationSystem](./Image/ch01/InformationSystem.PNG){ width="50%" }
...
![DataClassificationForm](./Image/ch01/DataClassificationForm.PNG){ width="50%" }
...
![StructuredData](./Image/ch01/StructuredData.PNG){ width="50%" }
...
![SemiStructuredData](./Image/ch01/SemiStructuredData.PNG){ width="50%" }
...
![UnstructuredData](./Image/ch01/UnstructuredData.PNG)

### 데이터 분류 특성

- 통계적 관점 & 데이터 분석 분야에서 사용

![DataClassificationCharacteristics](./Image/ch01/DataClassificationCharacteristics.PNG)
