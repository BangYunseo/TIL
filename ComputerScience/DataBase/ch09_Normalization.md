...
![InsertionAnomalyExample](./Image/ch09/InsertionAnomalyExample.PNG)
...
![UpdateAnomalyExample](./Image/ch09/UpdateAnomalyExample.PNG)
...
![DeletionAnomalyExample](./Image/ch09/DeletionAnomalyExample.PNG)
...
![FunctionalDependencyDefinition](./Image/ch09/FunctionalDependencyDefinition.PNG)
...
![UserRelationshipExample](./Image/ch09/UserRelationshipExample.PNG)
...
![UserDependencyDiagram](./Image/ch09/UserDependencyDiagram.PNG)
...
![EventRelationshipExample](./Image/ch09/EventRelationshipExample.PNG)
...
![UserEventDependencyDiagram](./Image/ch09/UserEventDependencyDiagram.PNG)
...
![FunctionalDependencyDiagramNotation](./Image/ch09/FunctionalDependencyDiagramNotation.PNG)
...
| ![NormalFormHierarchy1](./Image/ch09/NormalFormHierarchy1.PNG) | ![NormalFormHierarchy2](./Image/ch09/NormalFormHierarchy2.PNG) |
| --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
...
| ![FirstNormalFormExample1](./Image/ch09/FirstNormalFormExample1.PNG) | ![FirstNormalFormExample2](./Image/ch09/FirstNormalFormExample2.PNG) |
| ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |

|                                            함수 종속 관계                                            |                                                     함수 종속 다이어그램                                                     |
| :--------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------: |
| 고객아이디 -> 등급<br>고객아이디 -> 할인율<br>등급 -> 할인율<br>{고객아이디, 이벤트번호} -> 당첨여부 | ![FirstNormalFormDependencyDiagram](./Image/ch09/FirstNormalFormDependencyDiagram.PNG) |

- 이상 현상 발생 형태

![FirstNormalFormAnomalyIssue](./Image/ch09/FirstNormalFormAnomalyIssue.PNG)
...
![SecondNormalFormExample](./Image/ch09/SecondNormalFormExample.PNG)

|                                                     함수 종속 다이어그램                                                     |                                                      릴레이션 분해 결과                                                      |
| :--------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------: |
| ![SecondNormalFormDependencyDiagram](./Image/ch09/SecondNormalFormDependencyDiagram.PNG) | ![SecondNormalFormDecompositionResult](./Image/ch09/SecondNormalFormDecompositionResult.PNG) |

#### 고객 릴레이션 이상 현상

![SecondNormalFormAnomalyIssue](./Image/ch09/SecondNormalFormAnomalyIssue.PNG)
...
![TransitiveFunctionalDependency](./Image/ch09/TransitiveFunctionalDependency.PNG)
...
![ThirdNormalFormExample](./Image/ch09/ThirdNormalFormExample.PNG)

|                                                     함수 종속 다이어그램                                                     |
| :--------------------------------------------------------------------------------------------------------------------------: |
| ![ThirdNormalFormDependencyDiagram](./Image/ch09/ThirdNormalFormDependencyDiagram.PNG) |
...
![BoyceCoddNormalFormExample](./Image/ch09/BoyceCoddNormalFormExample.PNG)
...
|                                                     함수 종속 다이어그램                                                      |                                                           이상 현상                                                           |
| :---------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------: |
| ![BoyceCoddNormalFormDependencyDiagram](./Image/ch09/BoyceCoddNormalFormDependencyDiagram.PNG) | ![BoyceCoddNormalFormAnomalyIssue](./Image/ch09/BoyceCoddNormalFormAnomalyIssue.PNG) |

### 기본 정규화 과정

![AllNormalizationProcessFlow](./Image/ch09/AllNormalizationProcessFlow.PNG)
