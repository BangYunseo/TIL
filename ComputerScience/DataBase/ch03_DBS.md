...
|              단계               |                            스키마 종류                            | 설명                                                                                                                                                                                                                                                        |
| :-----------------------------: | :---------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  외부 단계<br>(External Level)  | 외부 스키마<<br>(External Schema)<br>·서브 스키마<br>(Sub Schema) | 1. 데이터베이스를 개별 사용자 관점에서 이해하고 표현하는 단계<br>2. 데이터베이스 하나에 여러 외부 스키마 존재<br>3. 사용자마다 생각하는 데이터베이스 형태·논리적 구조 상이                                                                                  |
