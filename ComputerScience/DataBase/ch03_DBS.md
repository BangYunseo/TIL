...
| 개념 단계<br>(Comceptual Level) |                  개념 스키마<br>(Conceptual Schema)                  | 1. 조직 전체 관점에서 이해하고 표현하는 단계<br>2. 데이터베이스 하나에 한 개의 개념 스키마 존재<br>3. 데이터들 간 관계·제약 조건·보안 정책·접근 권한에 대한 정의<br>4. 전체 데이터베이스에 어떤 데이터가 저장되는가?                     |
