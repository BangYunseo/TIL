...
- 조사횟수의 기대값 : $1 + \Sigma_{i ≥ 0}i × p_{i}$ ($ = 1 + 1 × p_1 + 2 × p_2 + 3 × p_3 + ...$)
- 다만 $p_i = q_i - q_{i + 1} 이면서 $q_i ≤ 𝛼^i(p_{4} = q_{4} - q_{5})$

- 그러므로 $1 + \Sigma*{i ≥ 0}i × p*{i} = 1 + \Sigma*{i ≥ 1}i × (q*{i} - q*{i + 1})= 1 + \Sigma*{i ≥ 1}q*{i} ≤ 1 + \Sigma*{i ≥ 1} 𝛼^{i} = \frac{1}{(1-α)}$
