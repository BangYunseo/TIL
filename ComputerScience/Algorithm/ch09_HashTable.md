...
- 조사횟수의 기대값 : $1 + \Sigma_{i ≥ 0}i \cdot p_{i}$ ($ = 1 + 1 \cdot p_1 + 2 \cdot p_2 + 3 \cdot p_3 + ...$)
- 다만
...
& p_i = q_i - q_{i + 1},\\
& q_i ≤ 𝛼^i(p_{4} = q_{4} - q_{5})\\\\

& 이므로\\\\

& 1 + \Sigma_{i ≥ 0}i \cdot p_{i} \\
& = 1 + \Sigma_{i ≥ 1}i \cdot (q_{i} - q_{i + 1})\\
& = 1 + \Sigma_{i ≥ 1}q_{i} ≤ 1 + \Sigma_{i ≥ 1} 𝛼^{i}\\
& = \frac{1}{(1-α)}
