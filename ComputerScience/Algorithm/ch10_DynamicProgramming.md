...
![FibonacciExample](./Image/ch10/FibonacciExample.PNG)
...
![MemoizationConcept](./Image/ch10/MemoizationConcept.PNG)
...
![MatrixPathInvalidDirections](./Image/ch10/MatrixPathInvalidDirections.PNG)

![MatrixPathValidDirections](./Image/ch10/MatrixPathValidDirections.PNG)

### 목표

![MatrixPathObjective](./Image/ch10/MatrixPathObjective.PNG)
...
![MoveMaxRecursionTree](./Image/ch10/MoveMaxRecursionTree.PNG)
...
![PebbleProblemGrid](./Image/ch10/PebbleProblemGrid.PNG)
...
![PebbleProblemConstraints](./Image/ch10/PebbleProblemConstraints.PNG)
...
![PatternOne](./Image/ch10/PatternOne.PNG)

- 양립 가능 패턴
  - 1 : 2 : 1
  - 1 : 3 : 1

![PatternOneCompatible](./Image/ch10/PatternOneCompatible.PNG)

#### 패턴 2

![PatternTwo](./Image/ch10/PatternTwo.PNG)
...
![PatternTwoCompatible](./Image/ch10/PatternTwoCompatible.PNG)

#### 패턴 3

![PatternThree](./Image/ch10/PatternThree.PNG)

- 양립 가능 패턴
  - 3 : 1 : 3
  - 3 : 2 : 3

![PatternThreeCompatible](./Image/ch10/PatternThreeCompatible.PNG)

#### 패턴 4

![PatternFour](./Image/ch10/PatternFour.PNG)

- 양립 가능 패턴
  - 4 : 2 : 4

![PatternFourCompatible](./Image/ch10/PatternFourCompatible.PNG)

### 문제 해결 예시

![PebbleSolutionPatternTwo](./Image/ch10/PebbleSolutionPatternTwo.PNG)

- i 열이 패턴 2로 놓여있는 경우의 최고점 계산

![PebbleSolutionCases](./Image/ch10/PebbleSolutionCases.PNG)
...
![PebbleRecursionTree](./Image/ch10/PebbleRecursionTree.PNG)
...
![LCSRecursionTree](./Image/ch10/LCSRecursionTree.PNG)
