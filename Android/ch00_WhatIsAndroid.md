...
![ch00-01-startPage](./Image/ch00/ch00-01-startPage.PNG)
...
![ch00-02-logCat](./Image/ch00/ch00-02-logCat.PNG){ width="70%" }
...
![ch00-03-androidStructure](./Image/ch00/ch00-03-androidStructure.PNG){ width="70%" }
...
![ch00-04-dex](./Image/ch00/ch00-04-dex.PNG){ width="60%" }
...
![ch00-05-component](./Image/ch00/ch00-05-component.PNG){ width="60%" }
...
![ch00-07-howComponent](./Image/ch00/ch00-07-howComponent.PNG){ width="60%" }

2) 컴포넌트는 앱 안에서 독립된 실행 단위

![ch00-08-componentSeparate](./Image/ch00/ch00-08-componentSeparate.PNG){ width="60%" }

- 컴포넌트끼리 서로 종속되지 않아 코드 결합 발생 X

3) 앱 실행 시점의 다양성

![ch00-09-manyView](./Image/ch00/ch00-09-manyView.PNG){ width="60%" }
...
![ch00-10-appLibrary](./Image/ch00/ch00-10-appLibrary.PNG){ width="60%" }

- 다른 애플리케이션을 라이브러리처럼 이용 가능

### 안드로이드 앱의 클래스

![ch00-06-classComponent](./Image/ch00/ch00-06-classComponent.PNG){ width="60%" }
...
![ch00-11-projectFolder](./Image/ch00/ch00-11-projectFolder.PNG){ width="60%" }
...
![ch00-12-res](./Image/ch00/ch00-12-res.PNG){ width="60%" }
