...
![array1](./Image/ch7/array1.PNG)

#### 배열의 필요성
* 많은 변수를 한 번에 저장할 수 있다.
	 
![array2](./Image/ch7/array2.PNG)

#### 배열의 특징
* 배열은 메모리의 연속적인 공간에 저장한다.   
  * ex) **배열의 필요성**에서 배열 요소 s[0]과 s[1]은 실제 메모리 상에서 붙어있다.     
...
![definearray](./Image/ch7/definearray.PNG)   

#### 배열 원소와 인덱스
* 인덱스(index) : 배열 원소의 번호   
* 인덱스는 1부터 시작되지 않고 0부터 시작된다.     

![array3](./Image/ch7/array3.PNG)  
...
![array4](./Image/ch7/array4.PNG)  

#### 배열 요소 접근

![array5](./Image/ch7/array5.PNG)   
...
```
![arrayindex](./Image/ch7/arrayindex.PNG) 

## 3절. 배열 채우기
#### 배열과 반복문
* 배열의 가장 큰 장점은 반복문을 사용해서 배열의 원소를 간편하게 처리할 수 있다는 점이다.
![arrayfor](./Image/ch7/arrayfor.PNG)  
...
![howmanyarray](./Image/ch7/howmanyarray.PNG) 
...
![howmanyarray2](./Image/ch7/howmanyarray2.PNG) 
...
![orignalarray](./Image/ch7/orignalarray.PNG) 
...
![sorting1](./Image/ch7/sorting1.PNG) 
...
```
![sortingRE](./Image/ch7/sortingRE.PNG) 
...
![rightway](./Image/ch7/rightway.PNG) 
...
![waysearch](./Image/ch7/waysearch.PNG) 
...
![binarysearch](./Image/ch7/binarysearch.PNG) 
...
![2tharray](./Image/ch7/2tharray.PNG) 
...
![2tharrayindex](./Image/ch7/2tharrayindex.PNG)   
...
![2tharrayreset](./Image/ch7/2tharrayreset.PNG)

* 행이 주어지지 않고 열만 주어진 2차원 배열 초기화

![2tharrayreset2](./Image/ch7/2tharrayreset2.PNG)

* 행이 주어지지 않고 열만 주어진 2차원 배열 초기화 - 2

![2tharrayreset3](./Image/ch7/2tharrayreset3.PNG)
...
![ntharray](./Image/ch7/ntharray.PNG)
