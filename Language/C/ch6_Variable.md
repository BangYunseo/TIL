...
![vtype](./Image/ch6/vtype.PNG)

#### 변수의 범위
* 변수는 크게 지역 변수와 전역 변수로 나눠진다.
	 
![vtype2](./Image/ch6/vtype2.PNG)

#### 지역 변수와 전역 변수

![localglobal](./Image/ch6/localglobal.PNG)

#### 같은 이름의 전역 변수와 지역 변수
	
![localglobal2](./Image/ch6/localglobal2.PNG)
...
![local1](./Image/ch6/local1.PNG)   

![local2](./Image/ch6/local2.PNG)  
...
* 자동 할당(automatuc allocation)
  * 블록에 들어갈 때 생성
  * 블록에서 나올 때 소멸  
![allocation](./Image/ch6/allocation.PNG)
* 생존 기간을 결정하는 요인
  * 변수가 선언된 위치
  * 저장 유형 지정자
* 저장 유형 지정자
...
* 전역 변수만이 연결을 가질 수 있다.  
 ...
 ![linkage](./Image/ch6/linkage.PNG)

#### 연결 예제
* 전역 변수는 외부 연결이 가능하다.	
 ![linkageex](./Image/ch6/linkageex.PNG)
...
![recursion](./Image/ch6/recursion.PNG)

#### 순환 함수의 구조
* 순환 알고리즘은 자기 자신을 순환적으로 호출하는 부분과 순환 호출을 멈추는 부분으로 구성되어 있다.
 
![recursion2](./Image/ch6/recursion2.PNG)
