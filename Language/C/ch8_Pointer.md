...
![pointer2](./Image/ch8/pointer2.PNG)
...
```
![memory](./Image/ch8/memory.PNG)


## 2절. 주소
#### 주소의 개념

![adress](./Image/ch8/adress.PNG)
...
![adressOP](./Image/ch8/adressOP.PNG)
...
![pointerV](./Image/ch8/pointerV.PNG)
...
![pointerV2](./Image/ch8/pointerV2.PNG)
...
![pointerV3](./Image/ch8/pointerV3.PNG)
...
![warningpointer1](./Image/ch8/warningpointer1.PNG)
...
![warningpointer2](./Image/ch8/warningpointer2.PNG)
...
```
![warningpointer3](./Image/ch8/warningpointer3.PNG)

#### 포인터의 사용 이유

![whypointer](./Image/ch8/whypointer.PNG)
...
![pointerop](./Image/ch8/pointerop.PNG)

![pointerop2](./Image/ch8/pointerop2.PNG)


#### 포인터 주소 연산

![pointerop3](./Image/ch8/pointerop3.PNG)

#### 포인터 증감 연산

![pointerop4](./Image/ch8/pointerop4.PNG)
...
![pointerarray](./Image/ch8/pointerarray.PNG) 
...
![pointerarray2](./Image/ch8/pointerarray2.PNG) 
...
![pointertoarray](./Image/ch8/pointertoarray.PNG) 

#### 포인터를 배열의 이름으로 사용

![pointertoname](./Image/ch8/pointertoname.PNG) 
...
// 10 
```
![ppointer](./Image/ch8/ppointer.PNG)
...
![ppointer2](./Image/ch8/ppointer2.PNG)

#### & 연산자와 * 연산자
* & 연산자 : 주소 연산자로, 변수의 주소를 반환한다.
* * 연산자 : 내용 연산자로, 포인터가 가리키는 곳의 내용을 반환한다.

![ppointer3](./Image/ch8/ppointer3.PNG)
...
![pipointer](./Image/ch8/pipointer.PNG)
...
// *p = 20
```
![starpointer](./Image/ch8/starpointer.PNG)
...
![adpointer](./Image/ch8/adpointer.PNG)
...
![whyerror](./Image/ch8/whyerror.PNG) 
...
![callpointer](./Image/ch8/callpointer.PNG) 

## 6절. scanf()
#### scanf() 함수
* 변수에 값을 저장하기 위해 변수의 주소를 입력받는다.

![scanf](./Image/ch8/scanf.PNG) 

## 7절. 매개 변수
#### 배열 매개 변수
* 일반 매개 변수와 배열 매개 변수
![argument](./Image/ch8/argument.PNG)

* why?
  * 배열을 함수로 복사하려면 많은 시간이 소모되므로 배열은 주소만을 전달
* 배열 매개 변수는 포인터로 생각할 수 있다.
![arrayarg](./Image/ch8/arrayarg.PNG)
...
![sametwoway](./Image/ch8/sametwoway.PNG)
...
![advantage](./Image/ch8/advantage.PNG)
