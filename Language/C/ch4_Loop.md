...
![howtoselect_loop](./Image/ch4/howtoselect_loop.PNG)

## 2절. while문
#### while
* 주어진 조건이 만족되는 동안 문장들을 반복 실행한다.
  
![while](./Image/ch4/while.PNG)   
![while1](./Image/ch4/while1.PNG) 

#### while문 실행 과정

![whilee](./Image/ch4/whilee.PNG)   
* 만일 i를 증가시키는 증가식이 없었다면, 무한 루프(infinite loop) 문제가 발생한다.
* 반복문을 사용할 때는 반드시 반복이 종료되는지 확인해야 한다.

#### if-while 비교

![if-while](./Image/ch4/if-while.PNG)   

#### while 문에서 주의할 점

![important_while](./Image/ch4/important_while.PNG)   
![important_while2](./Image/ch4/important_while2.PNG)  
...
![sentinel](./Image/ch4/sentinel.PNG)
...
![do-while](./Image/ch4/do-while.PNG)
...
#### for
* 정해진 횟수만큼 반복하는 구조
![for](./Image/ch4/for.PNG)

![for2](./Image/ch4/for2.PNG)

#### while 루프와 for 루프와의 관계 

![while-for](./Image/ch4/while-for.PNG)
...
![structure_for](./Image/ch4/structure_for.PNG)
...
![nested_loop](./Image/ch4/nested_loop.PNG)
...
![infinite_loop](./Image/ch4/infinite_loop.PNG)
...
![infinite_loop2](./Image/ch4/infinite_loop2.PNG)
...
![goto](./Image/ch4/goto.PNG)

#### goto 문 예제

![goto2](./Image/ch4/goto2.PNG)

#### continue 문
* 0부터 10까지의 정수 중에서 3의 배수만 제외하고 출력하는 예제를 살펴보자

![continue](./Image/ch4/continue.PNG)
...
![another_printf](./Image/ch4/another_printf.PNG)

![another_printf2](./Image/ch4/another_printf2.PNG)
