...
![Andd](./Image/ch2/Andd.PNG)  

#### 비트 OR 연산자   

![Orr](./Image/ch2/Orr.PNG)  

#### 비트 XOR 연산자   

![XOR](./Image/ch2/XOR.PNG)  

#### 비트 NOT 연산자  

![Nott](./Image/ch2/Nott.PNG)  
...
![left](./Image/ch2/left.PNG)
      
#### >> 연산자  
* 비트를 오른쪽으로 이동
* 값은 1/2배가 된다.   
      
![right](./Image/ch2/right.PNG)
...
![TypeChange](./Image/ch2/TypeChange.PNG)
