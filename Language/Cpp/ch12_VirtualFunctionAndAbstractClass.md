...
![overriding](./Image/ch12/overriding.PNG)
...
![db](./Image/ch12/db.PNG)

#### 오버라이딩된 함수를 호출하는 동적 바인딩

![ordb](./Image/ch12/ordb.PNG)

![ordb2](./Image/ch12/ordb2.PNG)
...
![abclass](./Image/ch12/abclass.PNG)

#### Shape를 추상 클래스로 수정

![abclass2](./Image/ch12/abclass2.PNG)
