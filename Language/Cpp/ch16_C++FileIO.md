...
![asciicode](./Image/ch16/asciicode.PNG)

#### 텍스트 파일의 내부

![elvis](./Image/ch16/elvis.PNG)

![elvis2](./Image/ch16/elvis2.PNG)
...
- 스트림 입출력 방식 지원
  ![stream](./Image/ch16/stream.PNG)

#### 템플릿에 char 타입으로 구체화한 클래스

![typedef](./Image/ch16/typedef.PNG)

#### 파일과 프로그램을 연결하는 파일 입출력 스트림

![iostream](./Image/ch16/iostream.PNG)
...
![filemode](./Image/ch16/filemode.PNG)
...
![readingline](./Image/ch15/readingline.PNG)
```
...
![textbinary](./Image/ch16/textbinary.PNG)

#### 텍스트 I/O와 바이너리 I/O의 실행 결과 비교

![textbinary2](./Image/ch16/textbinary2.PNG)
...
![streamstat](./Image/ch16/streamstat.PNG)

#### 스트림 상태를 나타내는 비트 정보

![streambit](./Image/ch16/streambit.PNG)

#### 스트림 상태를 검사하는 멤버 함수

![streammem](./Image/ch16/streammem.PNG)
...
![seekbase](./Image/ch16/seekbase.PNG)

#### seekg()에 의한 get pointer의 이동 사례

![seekg](./Image/ch16/seekg.PNG)

- 예제 12 참고 이미지  
  ![ex12](./Image/ch16/ex12.PNG)
