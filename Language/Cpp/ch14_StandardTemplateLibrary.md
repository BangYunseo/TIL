...
![STLcontainer](./Image/ch14/STLcontainer.PNG)

- iterator : 컨테이너 원소에 대한 포인터
  - 컨테이너의 원소들을 순회하면서 접근하기 위해 만들어진 컨테이너 원소에 대한 포인터

![STLiterator](./Image/ch14/STLiterator.PNG)

- 알고리즘 : 템플릿 함수
  - 컨테이너 원소에 대한 복사, 검색, 삭제, 정렬 등의 기능을 구현한 템플릿 함수
  - 컨테이너의 멤버 함수 아님

![STLalgorithm](./Image/ch14/STLalgorithm.PNG)
...
![container](./Image/ch14/container.PNG)

#### vector 클래스의 주요 멤버와 연산자

![vectormem](./Image/ch14/vectormem.PNG)

#### vector 다루기 사례

![vector](./Image/ch14/vector.PNG)
...
![iterator](./Image/ch14/iterator.PNG)
...
![lambda2](./Image/ch14/lambda2.PNG)
