...
![Staticor](./Image/ch08/Staticor.PNG)
...
![Staticor2](./Image/ch08/Staticor2.PNG)
...
![Staticor3](./Image/ch08/Staticor3.PNG)
...
![staticerror](./Image/ch08/staticerror.PNG)
...
- 그림으로 먼저 보기  
  ![staticmember](./Image/ch08/staticmember.PNG)
...
![staticmember2](./Image/ch08/staticmember2.PNG)
...
- 그림으로 먼저 보기  
  ![staticmember3](./Image/ch08/staticmember3.PNG)
...
- 그림으로 먼저 보기  
  ![Mathclass](./Image/ch08/Mathclass.PNG)
...
- 그림으로 먼저 보기  
  ![Circleclass](./Image/ch08/Circleclass.PNG)
...
- static 멤버 함수 getMoney()가 non-static 멤버 변수 money를 접근하는 오류
  ![getArea](./Image/ch08/getArea.PNG)
