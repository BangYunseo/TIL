...
![throwcatch](./Image/ch17/throwcatch.PNG)
...
![notexpt](./Image/ch17/notexpt.PNG)

- 예외가 발생한 경우

![expt](./Image/ch17/expt.PNG)
...
![mcatch](./Image/ch17/mcatch.PNG)

- 함수를 포함하는 try { } 블록

![includefunction](./Image/ch17/includefunction.PNG)
