...
![successoverloading](./Image/ch07/successoverloading.PNG)

#### 함수 중복 실패 사례

- 리턴 타입이 다르다고 함수 중복이 성공하지는 않음

  ![failoverloading](./Image/ch07/failoverloading.PNG)
...
![comfortableoverloading](./Image/ch07/comfortableoverloading.PNG)
...
![defconstructor](./Image/ch07/defconstructor.PNG)

#### string 클래스의 생성자 중복 사례

![stringconstructor](./Image/ch07/stringconstructor.PNG)
...
![parameterrule](./Image/ch07/parameterrule.PNG)

#### 매개 변수에 값을 정하는 규칙 - 2

![parameterrule2](./Image/ch07/parameterrule2.PNG)
...
![smalloverloading](./Image/ch07/smalloverloading.PNG)

- 중복 함수들과 다르게 디폴트 매개 변수를 가진 함수를 함께 사용 불가

![sameoverloading](./Image/ch07/sameoverloading.PNG)
...
![typetrans](./Image/ch07/typetrans.PNG)
