...
| ![ch03-01-MotionEvent](/Android/Image/ch03/ch03-01-MotionEvent.PNG) | 1) x : 이벤트가 발생한 뷰의 X 좌표<br>2) y : 이벤트가 발생한 뷰의 Y 좌표<br>3) rawX : 화면의 X 좌표<br>4) rawY : 화면의 Y 좌표 |
| ------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------- |
...
![ch03-02-KeyButton](/Android/Image/ch03/ch03-02-KeyButton.PNG){ width="30%" }
...
![ch03-03-ViewConnection](/Android/Image/ch03/ch03-03-ViewConnection.PNG){ width="50%" }
...
![ch03-04-CheckBox](/Android/Image/ch03/ch03-04-CheckBox.PNG){ width="60%" }
...
![ch03-05-ex](/Android/Image/ch03/ch03-05-ex.PNG){ width="30%" }
