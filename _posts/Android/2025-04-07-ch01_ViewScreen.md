---
title: "Chapter 1. 뷰를 이용한 화면 구성"
date: 2025-04-07 21:05:11 +0900
categories: [Android]
---
...
| ![ch01-01-viewScreen](/Android/Image/ch01/ch01-01-viewScreen.PNG) | ![ch01-02-viewScreen2](/Android/Image/ch01/ch01-02-viewScreen2.PNG) |
| ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
...
![ch01-03-viewStructure](/Android/Image/ch01/ch01-03-viewStructure.PNG){ width="70%" }
...
![ch01-04-LinearLayout](/Android/Image/ch01/ch01-04-LinearLayout.PNG){ width="20%" }

- 레이아웃 중첩
  - 뷰의 계층 구조 : 레이아웃 객체로 중첩해서 복잡한 구성 가능

![ch01-05-LinearLayout2](/Android/Image/ch01/ch01-05-LinearLayout2.PNG){ width="60%" }
...
![ch01-06-MarginPadding](/Android/Image/ch01/ch01-06-MarginPadding.PNG){ width="30%" }
...
![ch01-07-visibility](/Android/Image/ch01/ch01-07-visibility.PNG){ width="70%" }
...
![ch01-08-TextView](/Android/Image/ch01/ch01-08-TextView.PNG){ width="40%" }
...
![ch01-09-autoLink](/Android/Image/ch01/ch01-09-autoLink.PNG){ width="50%" }
...
![ch01-10-Lines](/Android/Image/ch01/ch01-10-Lines.PNG){ width="70%" }
...
![ch01-11-Lake](/Android/Image/ch01/ch01-11-Lake.PNG){ width="60%" }
...
![ch01-12-Buttons](/Android/Image/ch01/ch01-12-Buttons.PNG){ width="30%" }
...
![ch01-13-keyboards](/Android/Image/ch01/ch01-13-keyboards.PNG){ width="60%" }
...
![ch01-14-modules](/Android/Image/ch01/ch01-14-modules.PNG){ width="70%" }

### 2단계) 문자열 리소스 등록

- res/values/strings.xml 파일 수정

![ch01-15-strings](/Android/Image/ch01/ch01-15-strings.PNG){ width="70%" }
...
![ch01-16-excution](/Android/Image/ch01/ch01-16-excution.PNG){ width="70%" }
