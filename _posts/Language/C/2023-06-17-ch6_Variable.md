...
![vtype](/Language/C/Image/ch6/vtype.PNG)

#### 변수의 범위
* 변수는 크게 지역 변수와 전역 변수로 나눠진다.
	 
![vtype2](/Language/C/Image/ch6/vtype2.PNG)

#### 지역 변수와 전역 변수

![localglobal](/Language/C/Image/ch6/localglobal.PNG)

#### 같은 이름의 전역 변수와 지역 변수
	
![localglobal2](/Language/C/Image/ch6/localglobal2.PNG)
...
![local1](/Language/C/Image/ch6/local1.PNG)   

![local2](/Language/C/Image/ch6/local2.PNG)  
...
![local3](/Language/C/Image/ch6/local3.PNG)  
...
![global1](/Language/C/Image/ch6/global1.PNG)  
...
![global2](/Language/C/Image/ch6/global2.PNG)  
...
```
* 위 코드의 출력은 아래와 같이 된다.
![global3](/Language/C/Image/ch6/global3.PNG)   
...
![local4](/Language/C/Image/ch6/local4.PNG)  
...
* 자동 할당(automatuc allocation)
  * 블록에 들어갈 때 생성
  * 블록에서 나올 때 소멸  
![allocation](/Language/C/Image/ch6/allocation.PNG)
* 생존 기간을 결정하는 요인
  * 변수가 선언된 위치
  * 저장 유형 지정자
* 저장 유형 지정자
...
![auto](/Language/C/Image/ch6/auto.PNG)

#### 저장 유형 지정자 static 
* 지역변수처럼 블록에서만 사용되지만, 블록을 벗어나도 자동으로 제거되지 않는 변수
* 이런 변수를 정적 변수라고 부른다.

![static](/Language/C/Image/ch6/static.PNG)

#### 함수 앞의 static
* 변수나 함수 이름은 모두 식별자이므로 같은 조건으로 취급된다.

![static2](/Language/C/Image/ch6/static2.PNG)

#### 저장 유형 지정자 register
* 레지스터(register)에 변수를 저장 
  
![register](/Language/C/Image/ch6/register.PNG)

#### volatile
* volatile 지정자는 하드웨어가 수시로 변수의 값을 변경하는 경우에 사용된다.
* 마이크로프로세서에서 사용된다.
 ![volatile](/Language/C/Image/ch6/volatile.PNG)

#### 외부 연결
* 전역 변수를 extern을 이용해서 서로 연결한다.

 ![linkage2](/Language/C/Image/ch6/linkage2.PNG)

#### 블록에서 extern을 이용한 전역 변수 참조
* extern은 블록에서 전역 변수에 접근할 때도 사용된다.
* 
![extern](/Language/C/Image/ch6/extern.PNG)
...
* 전역 변수만이 연결을 가질 수 있다.  
 ...
 ![linkage](/Language/C/Image/ch6/linkage.PNG)

#### 연결 예제
* 전역 변수는 외부 연결이 가능하다.	
 ![linkageex](/Language/C/Image/ch6/linkageex.PNG)
...
![recursion](/Language/C/Image/ch6/recursion.PNG)

#### 순환 함수의 구조
* 순환 알고리즘은 자기 자신을 순환적으로 호출하는 부분과 순환 호출을 멈추는 부분으로 구성되어 있다.
 
![recursion2](/Language/C/Image/ch6/recursion2.PNG)
