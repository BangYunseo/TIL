...
* (참고) ++x와 x++의 차이
![++xandxx++](/Language/C/Image/ch2/++xandx++.PNG)
...
![iff](/Language/C/Image/ch2/iff.PNG)  
...
![Andd](/Language/C/Image/ch2/Andd.PNG)  

#### 비트 OR 연산자   

![Orr](/Language/C/Image/ch2/Orr.PNG)  

#### 비트 XOR 연산자   

![XOR](/Language/C/Image/ch2/XOR.PNG)  

#### 비트 NOT 연산자  

![Nott](/Language/C/Image/ch2/Nott.PNG)  
...
![left](/Language/C/Image/ch2/left.PNG)
      
#### >> 연산자  
* 비트를 오른쪽으로 이동
* 값은 1/2배가 된다.   
      
![right](/Language/C/Image/ch2/right.PNG)
...
![TypeChange](/Language/C/Image/ch2/TypeChange.PNG)
