...
![struct](/Language/C/Image/Struct/struct.PNG)
...
![needstruct](/Language/C/Image/Struct/needstruct.PNG)

### 구조체 개념

![struct2](/Language/C/Image/Struct/struct2.PNG)

### 구조체와 배열

![arraystruct](/Language/C/Image/Struct/arraystruct.PNG)

### 구조체 정의 개념

- 구조체를 자료형으로 사용하려면 먼저 구조체를 정의
  - 구조체를 만들 구조체 틀(template)을 정의
    ![structtemplate](/Language/C/Image/Struct/structtemplate.PNG)

### 구조체 정의 구문

![structcode](/Language/C/Image/Struct/structcode.PNG)
...
![struct4](/Language/C/Image/Struct/struct4.PNG)

## 2절. 선언

### 구조체 선언

![struct3](/Language/C/Image/Struct/struct3.PNG)
...
![structdef](/Language/C/Image/Struct/structdef.PNG)
...
![structaccount](/Language/C/Image/Struct/structaccount.PNG)
...
![structstudent](/Language/C/Image/Struct/structstudent.PNG)

### 구조체 멤버 참조

![structmem](/Language/C/Image/Struct/structmem.PNG)
...
{% raw %}struct account me = {{2012, 3, 9}, "홍길동", 1001, 30000 };	// 구조체 변수 선언{% endraw %}
...
![structdate](/Language/C/Image/Struct/structdate.PNG)
...
![structarray](/Language/C/Image/Struct/structarray.PNG)
...
![structarrayv](/Language/C/Image/Struct/structarrayv.PNG)
...
![pointerarray](/Language/C/Image/Struct/pointerarray.PNG)
...
![sp](/Language/C/Image/Struct/sp.PNG)
...
![structpointerp](/Language/C/Image/Struct/structpointerp.PNG)
...
![structpointeros](/Language/C/Image/Struct/structpointeros.PNG)
...
![pointerp](/Language/C/Image/Struct/pointerp.PNG)
...
![structdef1](/Language/C/Image/Struct/structdef1.PNG)

- 구조체의 포인터를 함수의 인수로 전달하는 경우
  - 시간과 메모리 절약 가능
  - 원본 훼손의 가능성 존재

![structdef2](/Language/C/Image/Struct/structdef2.PNG)

### 구조체를 반환하는 경우

- 복사본이 반환됨

![structreturn](/Language/C/Image/Struct/structreturn.PNG)
