...
![functionN](/Language/C/Image/ch5/functionN.PNG)
...
![functionN1](/Language/C/Image/ch5/functionN1.PNG)

#### 함수의 종류

![FunctionType](/Language/C/Image/ch5/FuntionType.PNG)   

#### 함수의 정의

![defineFunction](/Language/C/Image/ch5/defineFunction.PNG)   
...
![functionName](/Language/C/Image/ch5/functionName.PNG)
...
* 함수 호출(function call)
  ...
  * 호출된 함수로 이동해서 함수 몸체 안의 문장들이 순차적으로 실행된다.   
  ...
  ![functionCall](/Language/C/Image/ch5/functionCall.PNG)
...
* 일반적으로 함수의 원형을 사용하는 것이 좋다.
 ...
 ![functionnn](/Language/C/Image/ch5/functionnn.PNG)
...
![functionAA](/Language/C/Image/ch5/functionAA.PNG)

![functionAB](/Language/C/Image/ch5/functionAB.PNG)
...
![functionBB](/Language/C/Image/ch5/functionBB.PNG)   
...
* 함수 사용 예시		
![getinteger](/Language/C/Image/ch5/getinteger.PNG)
...
* 다음 getchar()함수가 호출될 때 먼저 개행문자가 호출되면서 입력을 받지 못하는 문제가 발생할 수 있다.  
 ...
 ![GetcharScanf](/Language/C/Image/ch5/GetcharScanf.PNG)
 ![getchar1](/Language/C/Image/ch5/getchar1.PNG)
 ![getchar2](/Language/C/Image/ch5/getchar2.PNG)
...
![mathh](/Language/C/Image/ch5/mathh.PNG)

#### floor()함수와 ceil()함수

![floorceil](/Language/C/Image/ch5/floorceil.PNG)
...
![anyfunction](/Language/C/Image/ch5/anyfunction.PNG)
...
![modularization](/Language/C/Image/ch5/modularization.PNG)
