...
![variable](/Language/Java/Image/ch01/variable.PNG)
...
![variable1](/Language/Java/Image/ch01/variable1.PNG)

* 같은 타입의 변수는 콤마를 이용해 한꺼번에 선언

![variable2](/Language/Java/Image/ch01/variable2.PNG)

#### 변수 이름
* Java에서 정한 작성 규칙

![variablename](/Language/Java/Image/ch01/variablename.PNG)

#### 예약어
* Java에서 의미를 가지고 사용되는 단어
* 변수 이름으로 사용할 경우 컴파일 에러 발생

![variablename1](/Language/Java/Image/ch01/variablename1.PNG)

#### 변수 저장
* 값을 저장할 경우 대입 연산자 (=) 사용
  * 변수 선언 후 대입 연산자를 통해 오른쪽의 값을 왼쪽 변수에 저장

![variablesave](/Language/Java/Image/ch01/variablesave.PNG)
...
![variablereset](/Language/Java/Image/ch01/variablereset.PNG)

* 초기화를 하지 않은 변수는 메모리에서 값을 읽을 수 없음

![variableresetno](/Language/Java/Image/ch01/variableresetno.PNG)

#### 변수 사용 
* 변수의 값을 이용해서 출력문이나 연산식을 수행

![usevariable](/Language/Java/Image/ch01/usevariable.PNG)

#### 변수 값 복사
* 변수의 값을 다른 변수에 저장

![copyvariable](/Language/Java/Image/ch01/copyvariable.PNG)
...
![localvariable](/Language/Java/Image/ch01/localvariable.PNG)

* 지역 변수는 해당 중괄호 블록 내에서만 사용 가능

![localvariable1](/Language/Java/Image/ch01/localvariable1.PNG)
...
![PrimitiveType](/Language/Java/Image/ch01/PrimitiveType.PNG)

* 정수 타입
  * 메모리 사용 크기와 저장되는 값의 허용 범위에 차이 존재
      
![IntType](/Language/Java/Image/ch01/IntType.PNG)

* 메모리

![Memory](/Language/Java/Image/ch01/Memory.PNG)

#### 리터럴(literal)
* 소스 코드에서 프로그래머에 의해 직접 입력된 값
* 아래의 경우 자바에서 정수로 인식

![Exchange](/Language/Java/Image/ch01/Exchange.PNG)
...
![char](/Language/Java/Image/ch01/char.PNG)

* char는 정수 타입
  * 10진수 또는 16진수 형태의 유니코드 저장 가능

![char2](/Language/Java/Image/ch01/char2.PNG)

#### 문자열
* 큰따옴표로 감싼 문자들
* 문자열은 char 타입이 아닌 String 타입에 저장

![string](/Language/Java/Image/ch01/string.PNG)
...
![escape](/Language/Java/Image/ch01/escape.PNG)

* 예시 2) 문자열 출력 제어

![escape2](/Language/Java/Image/ch01/escape2.PNG)
...
![fd](/Language/Java/Image/ch01/fd.PNG)
...
![fd2](/Language/Java/Image/ch01/fd2.PNG)

#### double 타입
* double 타입 변수에 저장
  * Java는 실수 리터럴을 기본적으로 double 타입으로 해석

![double](/Language/Java/Image/ch01/double.PNG)

#### float 타입
* float 타입 변수에 저장
  * 리터럴 뒤 f 혹은 F를 붙여 float 타입 표시

![float](/Language/Java/Image/ch01/float.PNG)
...
![promotion](/Language/Java/Image/ch01/promotion.PNG)
...
![casting](/Language/Java/Image/ch01/casting.PNG)
...
![inttype2](/Language/Java/Image/ch01/inttype2.PNG)

* 피연산자 중 하나가 long 타입이면 다른 피연산자는 long 타입으로 자동 변환   

![longtype](/Language/Java/Image/ch01/longtype.PNG)
...
![doubletype](/Language/Java/Image/ch01/doubletype.PNG)
...
![type+](/Language/Java/Image/ch01/type+.PNG)

* '+ 연산'은 앞에서부터 순차적으로 수행
  * 먼저 수행된 연산이 결합 연산인 경우 이후 모든 연산은 결합 연산

![type+2](/Language/Java/Image/ch01/type+2.PNG)

#### 기본 타입
* 문자열을 기본 타입으로 강제 변환

![Casting2](/Language/Java/Image/ch01/Casting2.PNG)
...
![println](/Language/Java/Image/ch01/println.PNG)

#### 여러가지 출력 메소드
          
![print](/Language/Java/Image/ch01/print.PNG)

#### printf()
* 형식화된 문자열(formal string) 출력
* 전체 출력 자릿수 및 소수 자릿수 제한

![printf](/Language/Java/Image/ch01/printf.PNG)
...
![print2](/Language/Java/Image/ch01/print2.PNG)
...
![keycode](/Language/Java/Image/ch01/keycode.PNG)
...
![scan](/Language/Java/Image/ch01/scan.PNG)
...
![scan](/Language/Java/Image/ch01/strequal.PNG)
