...
![expression](/Language/Java/Image/ch02/expression.PNG)

#### JAVA 연산자
* 산출되는 값의 타입이 연산자별로 다름을 주의

![JavaExpression](/Language/Java/Image/ch02/JavaExpression.PNG)
...
![ExpressionDirection](/Language/Java/Image/ch02/ExpressionDirection.PNG)

#### 괄호 사용
* 먼저 처리할 연산식을 괄호로 묶기

![ExpressionDirectionEX1](/Language/Java/Image/ch02/ExpressionDirectionEX1.PNG)
...
![expression2](/Language/Java/Image/ch02/expression2.PNG)
...
![ExpressionPlus](/Language/Java/Image/ch02/ExpressionPlus.PNG)
...
![ExpressionPlus2](/Language/Java/Image/ch02/ExpressionPlus2.PNG)
...
### 3 - 2 ) 이항 연산자
#### 산술 연산자
![ExpressionMath](/Language/Java/Image/ch02/ExpressionMath.PNG)   
...
![ExpressionIs](/Language/Java/Image/ch02/ExpressionIs.PNG)  

#### 논리 연산자
* boolean 타입만 사용 가능

![ExpressionBool](/Language/Java/Image/ch02/ExpressionBool.PNG)  

#### 대입 연산자
* 오른쪽 피연산자의 값을 왼쪽 피연산자인 변수에 저장

![ExpressionEqual](/Language/Java/Image/ch02/ExpressionEqual.PNG)  
...
![Expression3](/Language/Java/Image/ch02/Expression3.PNG)  
