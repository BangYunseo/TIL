...
![Pointer](/Language/Cpp/Image/ch04/Pointer.PNG)
...
- 예제 2의 설명  
  ![ex4_2](/Language/Cpp/Image/ch04/ex4_2.PNG)

#### 객체 배열 생성 시 기본 생성자 호출

![obcon](/Language/Cpp/Image/ch04/obcon.PNG)
...
- 2차원 배열 선언  
  ![arr2_1](/Language/Cpp/Image/ch04/arr2_1.PNG)

- 2차원 배열 선언과 초기화  
  ![arr2_2](/Language/Cpp/Image/ch04/arr2_2.PNG)

- 2차원 배열을 초기화하는 다른 방식  
  ![arr2_3](/Language/Cpp/Image/ch04/arr2_3.PNG)
...
![pointermemory](/Language/Cpp/Image/ch04/pointermemory.PNG)
...
- 그림으로 이해하기
  ![arrpointermemory](/Language/Cpp/Image/ch04/arrpointermemory.PNG)
...
- 그림으로 이해하기
  ![returnobject](/Language/Cpp/Image/ch04/returnobject.PNG)
...
- 그림으로 이해하기
  ![returnarrayobject](/Language/Cpp/Image/ch04/returnarrayobject.PNG)
...
![memory](/Language/Cpp/Image/ch04/memory.PNG)
...
![this](/Language/Cpp/Image/ch04/this.PNG)

#### this가 필요한 경우

- 매개 변수의 이름과 멤버 변수의 이름이 같은 경우
  ![this2](/Language/Cpp/Image/ch04/this2.PNG)

- 멤버 함수가 객체 자신의 주소를 리턴할 때
  - 연산자 중복 시에 필요

![this3](/Language/Cpp/Image/ch04/this3.PNG)
...
- 컴파일러에서 처리
  ![thiscom](/Language/Cpp/Image/ch04/thiscom.PNG)
