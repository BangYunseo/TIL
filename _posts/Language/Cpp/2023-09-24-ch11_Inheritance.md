...
![inim](/Language/Cpp/Image/ch11/inim.PNG)
...
![inclass](/Language/Cpp/Image/ch11/inclass.PNG)

#### 상속 선언

![instudent](/Language/Cpp/Image/ch11/inclass.PNG)
...
![po](/Language/Cpp/Image/ch11/po.PNG)

![cpo](/Language/Cpp/Image/ch11/cpo.PNG)

#### 파생 클래스에서 기본 클래스 멤버 접근

![cpo2](/Language/Cpp/Image/ch11/cpo2.PNG)

#### 외부에서 파생 클래스 객체에 대한 접근

![cpo3](/Language/Cpp/Image/ch11/cpo3.PNG)
...
![upcasting](/Language/Cpp/Image/ch11/upcasting.PNG)
...
![downcasting](/Language/Cpp/Image/ch11/downcasting.PNG)
...
![am](/Language/Cpp/Image/ch11/am.PNG)
...
![ppp](/Language/Cpp/Image/ch11/ppp.PNG)
...
![con1](/Language/Cpp/Image/ch11/con1.PNG)
...
![basiccon](/Language/Cpp/Image/ch11/basiccon.PNG)

#### 기본 클래스에 기본 생성자가 없는 경우 : 컴파일 오류

![errorcon](/Language/Cpp/Image/ch11/errorcon.PNG)

#### 매개 변수를 가진 파생 클래스의 생성자는 묵시적으로 기본 클래스의 기본 생성자 선택

- 파생 클래스의 매개 변수를 가진 생성자가 기본 클래스의 기본 생성자를 호출

![basiccon2](/Language/Cpp/Image/ch11/basiccon2.PNG)

#### 파생 클래스의 생성자에서 명시적으로 기본 클래스의 생성자 선택

![basiccon3](/Language/Cpp/Image/ch11/basiccon3.PNG)

#### 컴파일러의 기본 생성자 호출 코드 삽입

![con2](/Language/Cpp/Image/ch11/con2.PNG)
...
![ti](/Language/Cpp/Image/ch11/ti.PNG)
...
![ti2](/Language/Cpp/Image/ch11/ti2.PNG)
...
![vi](/Language/Cpp/Image/ch11/vi.PNG)
