...
![linking](/Language/Cpp/Image/ch18/linking.PNG)

#### C++ 소스의 컴파일과 링킹

![linking2](/Language/Cpp/Image/ch18/linking2.PNG)

#### C++에서 C 언어 함수 호출 시 링크 오류 발생

![C++C](/Language/Cpp/Image/ch18/C++C.PNG)

#### Visual C++ 에서의 링크 오류 메시지

![errorC++](/Language/Cpp/Image/ch18/errorC++.PNG)
...
![linkingC](/Language/Cpp/Image/ch18/linkingC.PNG)
