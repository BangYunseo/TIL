...
![myswap](/Language/Cpp/Image/ch13/myswap.PNG)

#### 중복 함수들로부터 템플릿 만들기 사례

![myswap2](/Language/Cpp/Image/ch13/myswap2.PNG)
...
![intT](/Language/Cpp/Image/ch13/intT.PNG)

#### 제네릭 함수로부터 구체화된 함수 생성 사례

![special](/Language/Cpp/Image/ch13/special.PNG)
...
![errorspecial](/Language/Cpp/Image/ch13/errorspecial.PNG)
...
![charspec](/Language/Cpp/Image/ch13/charspec.PNG)
...
![coutabc1](/Language/Cpp/Image/ch13/coutabc1.PNG)

- 예제 7의 라인 39 ~ 40을 다음과 같이 연결하면 잘못된 결과가 나오며 이유는 아래와 같음
  ![coutabc2](/Language/Cpp/Image/ch13/coutabc2.PNG)
