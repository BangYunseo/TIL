---
title: "Chapter 3. 클래스와 객체"
date: 2023-11-17 23:19:28 +0900
...
![TVclass](/Language/Cpp/Image/ch03/TVclass.PNG)
...
![ClassObject](/Language/Cpp/Image/ch03/ClassObject.PNG)
...
- 그림으로 클래스 작성 확인하기  
  ![MakeClass](/Language/Cpp/Image/ch03/MakeClass.PNG)

![ObjectMaker](/Language/Cpp/Image/ch03/ObjectMaker.PNG)
...
- 클래스 이름과 동일한 멤버 함수
  ![constructor](/Language/Cpp/Image/ch03/constructor.PNG)
...
- 그림으로 이해하기
  ![make2con](/Language/Cpp/Image/ch03/make2con.PNG)
...
![con22](/Language/Cpp/Image/ch03/con22.PNG)
...
![con3](/Language/Cpp/Image/ch03/con3.PNG)
...
![con4](/Language/Cpp/Image/ch03/con4.PNG)
...
![des](/Language/Cpp/Image/ch03/des.PNG)
...
![ex7](/Language/Cpp/Image/ch03/ex7.PNG)
...
- 접근 지정의 중복
- ![AM](/Language/Cpp/Image/ch03/AM.PNG)

- 디폴트 접근 지정 private
- ![AM2](/Language/Cpp/Image/ch03/AM2.PNG)

- 멤버 변수의 private 지정
- ![AM3](/Language/Cpp/Image/ch03/AM3.PNG)

- 컴파일 오류 판정해보기
- ![QuestionAM1](/Language/Cpp/Image/ch03/QAM1.PNG)

![QuestionAM2](/Language/Cpp/Image/ch03/QAM2.PNG)
...
![function1](/Language/Cpp/Image/ch03/function1.PNG)
...
![inline1](/Language/Cpp/Image/ch03/inline1.PNG)
...
![inline2](/Language/Cpp/Image/ch03/inline2.PNG)
...
- 구조체는 public, 클래스는 private
  ![pubpri](/Language/Cpp/Image/ch03/pubpri.PNG)
...
![seph](/Language/Cpp/Image/ch03/seph.PNG)

#### 헤더 파일의 중복 include 문제

- 중복 include를 할 때 생기는 문제

![errorseph](/Language/Cpp/Image/ch03/errorseph.PNG)

- 헤더 파일의 중복 include로 인해 생기는 문제를 조건 컴파일로 해결

![errorseph1](/Language/Cpp/Image/ch03/errorseph1.PNG)

![errorseph2](/Language/Cpp/Image/ch03/errorseph2.PNG)
