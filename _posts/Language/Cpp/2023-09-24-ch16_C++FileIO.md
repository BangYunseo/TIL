...
![asciicode](/Language/Cpp/Image/ch16/asciicode.PNG)

#### 텍스트 파일의 내부

![elvis](/Language/Cpp/Image/ch16/elvis.PNG)

![elvis2](/Language/Cpp/Image/ch16/elvis2.PNG)
...
![uisee](/Language/Cpp/Image/ch16/uisee.PNG)
...
- 스트림 입출력 방식 지원
  ![stream](/Language/Cpp/Image/ch16/stream.PNG)

#### 템플릿에 char 타입으로 구체화한 클래스

![typedef](/Language/Cpp/Image/ch16/typedef.PNG)

#### 파일과 프로그램을 연결하는 파일 입출력 스트림

![iostream](/Language/Cpp/Image/ch16/iostream.PNG)
...
![song](/Language/Cpp/Image/ch16/song.PNG)
...
![filemode](/Language/Cpp/Image/ch16/filemode.PNG)
...
![EOFget](/Language/Cpp/Image/ch16/EOFget.PNG)
...
- 예제 4 참고 이미지  
  ![ex4](/Language/Cpp/Image/ch16/ex4.PNG)
...
- 예제 10 참고 이미지  
  ![ex10](/Language/Cpp/Image/ch16/ex10.PNG)
...
![textbinary](/Language/Cpp/Image/ch16/textbinary.PNG)

#### 텍스트 I/O와 바이너리 I/O의 실행 결과 비교

![textbinary2](/Language/Cpp/Image/ch16/textbinary2.PNG)
...
![streamstat](/Language/Cpp/Image/ch16/streamstat.PNG)

#### 스트림 상태를 나타내는 비트 정보

![streambit](/Language/Cpp/Image/ch16/streambit.PNG)

#### 스트림 상태를 검사하는 멤버 함수

![streammem](/Language/Cpp/Image/ch16/streammem.PNG)
...
![FileMP](/Language/Cpp/Image/ch16/FileMP.PNG)
...
![seekbase](/Language/Cpp/Image/ch16/seekbase.PNG)

#### seekg()에 의한 get pointer의 이동 사례

![seekg](/Language/Cpp/Image/ch16/seekg.PNG)

- 예제 12 참고 이미지  
  ![ex12](/Language/Cpp/Image/ch16/ex12.PNG)
