---
title: "Chapter 2. 블록 암호"
date: 2024-05-17 23:53:08 +0900
...
![BC](/Security/InformationSecurity/Image/ch02/BC.PNG)

#### 스트림 암호(Stream Cipher)
* 암호화 / 해독 시 메시지를 한 번에 비트 또는 바이트 단위로 처리

![SC](/Security/InformationSecurity/Image/ch02/SC.PNG)
...
![RM](/Security/InformationSecurity/Image/ch02/RM.PNG)
...
![IM](/Security/InformationSecurity/Image/ch02/IM.PNG)
...
![IBC](/Security/InformationSecurity/Image/ch02/IBC.PNG)
...
![SPN](/Security/InformationSecurity/Image/ch02/SPN.PNG)
...
![FCS](/Security/InformationSecurity/Image/ch02/FCS.PNG)
...
![XOR](/Security/InformationSecurity/Image/ch02/XOR.PNG)

* $((A ⊕ B) ⊕ B) = (A ⊕ (B ⊕ B)) = C ⊕ B = A ⊕ 0$이므로 $A = B ⊕ C$

* 파이스텔 구조와 관련된 XOR 연산 예제

![XOR2](/Security/InformationSecurity/Image/ch02/XOR2.PNG)
...
![DES](/Security/InformationSecurity/Image/ch02/DES.PNG)

#### $IP$와 $IP^{-1}$

![IP](/Security/InformationSecurity/Image/ch02/IP.PNG)
...
![IP2](/Security/InformationSecurity/Image/ch02/IP2.PNG)
...
![SDES](/Security/InformationSecurity/Image/ch02/SDES.PNG)

#### $E$ 와 $P$

![EP](/Security/InformationSecurity/Image/ch02/EP.PNG)

#### 라운드 함수 $F$

![RF](/Security/InformationSecurity/Image/ch02/RF.PNG)

#### 치환 박스
* 각 S-box는 6비트 입력을 4비트 출력으로 맵핑
* 0 ~ 15의 16개 숫자가 64칸에 맞춰 반복

![SB](/Security/InformationSecurity/Image/ch02/SB.PNG)
...
![DESKEY](/Security/InformationSecurity/Image/ch02/DESKEY.PNG)
...
![EXDES](/Security/InformationSecurity/Image/ch02/EXDES.PNG)

* DES에서의 눈사태 효과

![AEDES](/Security/InformationSecurity/Image/ch02/AEDES.PNG)
