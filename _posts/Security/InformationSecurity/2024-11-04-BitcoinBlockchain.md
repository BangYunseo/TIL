---
title: "비트코인과 블록체인(Bitcoin & Blockchain)"
date: 2024-11-04 23:06:34 +0900
categories: [Security, InformationSecurity]
math: true
---
...
![DSBA](/Security/InformationSecurity/Image/Bitcoin/DSBA.PNG)
...
![BA](/Security/InformationSecurity/Image/Bitcoin/BA.PNG)

![BA2](/Security/InformationSecurity/Image/Bitcoin/BA2.PNG)
...
![TRAC](/Security/InformationSecurity/Image/Bitcoin/TRAC.PNG)

#### 트랜잭션 순환구조

![TL](/Security/InformationSecurity/Image/Bitcoin/TL.PNG)

#### 일반적인 트랜잭션 형태

![CTF](/Security/InformationSecurity/Image/Bitcoin/CTF.PNG)

#### 트랜잭션 입-출력

- Input

![TIP](/Security/InformationSecurity/Image/Bitcoin/TIP.PNG)

- Output

![TOP](/Security/InformationSecurity/Image/Bitcoin/TOP.PNG)
...
![LUL](/Security/InformationSecurity/Image/Bitcoin/LUL.PNG)

#### 스크립트 언어(Script Language)

![SL](/Security/InformationSecurity/Image/Bitcoin/SL.PNG)

![SL2](/Security/InformationSecurity/Image/Bitcoin/SL2.PNG)
...
![VA](/Security/InformationSecurity/Image/Bitcoin/VA.PNG)
...
![BlockChain](/Security/InformationSecurity/Image/Bitcoin/BlockChain.PNG)
...
![BF](/Security/InformationSecurity/Image/Bitcoin/BF.PNG)

#### 트랜잭션 수수료(Transaction Fees)

![TF](/Security/InformationSecurity/Image/Bitcoin/TF.PNG)
...
![MCTF](/Security/InformationSecurity/Image/Bitcoin/MCTF.PNG)

#### 채굴 하드웨어 비교

- 가격당 해시와 전기 효율성을 기준 비교

![MHC](/Security/InformationSecurity/Image/Bitcoin/MHC.PNG)
...
![MP](/Security/InformationSecurity/Image/Bitcoin/MP.PNG)
...
![MHPS](/Security/InformationSecurity/Image/Bitcoin/MHPS.PNG)

- 현실 응용

![MHPS2](/Security/InformationSecurity/Image/Bitcoin/MHPS2.PNG)
...
![BMC](/Security/InformationSecurity/Image/Bitcoin/BMC.PNG)

#### 비트코인 채굴과 지속 가능성

![BMS](/Security/InformationSecurity/Image/Bitcoin/BMS.PNG)

#### 암호화 히터

![CH](/Security/InformationSecurity/Image/Bitcoin/CH.PNG)

#### 작업 증명과 지분 증명(Proof of Work vs Proof of Stake)

![PWPS](/Security/InformationSecurity/Image/Bitcoin/PWPS.PNG)

#### 암호화폐(Cryptocurrencies)

![Cc](/Security/InformationSecurity/Image/Bitcoin/Cc.PNG)
...
![AOL](/Security/InformationSecurity/Image/Bitcoin/AOL.PNG)
