---
title: "Chapter 13. 암호학(Cryptography)"
date: 2024-11-24 13:41:40 +0900
...
![EC](/Security/InformationSecurity/Image/ch16/EC.PNG)
...
![EC1](/Security/InformationSecurity/Image/ch16/EC1.PNG)

#### 군 연산(Group Law)

![GL](/Security/InformationSecurity/Image/ch16/GL.PNG)

![GL1](/Security/InformationSecurity/Image/ch16/GL1.PNG)

#### 유한 필드 상의 타원 곡선(Elliptic Curves over Finite Fields)

![ECFF](/Security/InformationSecurity/Image/ch16/ECFF.PNG)

##### $E_{23}(1, 1) : y^2 = x^3 + x + 1$ over $F_{23}$

![E23](/Security/InformationSecurity/Image/ch16/E23.PNG)

![E231](/Security/InformationSecurity/Image/ch16/E231.PNG)

#### 타원 곡선 상의 점 덧셈/배수 계산(Elliptic Curve Point Addition/Doubling)

![AD](/Security/InformationSecurity/Image/ch16/AD.PNG)

##### $E _{61}(1,−1) : y^2 = x^3 − x$ over $F_{61}$

![E61](/Security/InformationSecurity/Image/ch16/E61.PNG)
...
![PS](/Security/InformationSecurity/Image/ch16/PS.PNG)
...
![TLS](/Security/InformationSecurity/Image/ch16/TLS.PNG)
...
![TRPO](/Security/InformationSecurity/Image/ch16/TRPO.PNG)
...
![TRPF](/Security/InformationSecurity/Image/ch16/TRPF.PNG)

## 3절. TLS의 프로토콜 유형

#### 변경 암호 사양 프로토콜(Change Cipher Spec Protocol)

![CCSP](/Security/InformationSecurity/Image/ch16/CCSP.PNG)
...
![AP](/Security/InformationSecurity/Image/ch16/AP.PNG)
...
![HP](/Security/InformationSecurity/Image/ch16/HP.PNG)
...
![THPMT](/Security/InformationSecurity/Image/ch16/THPMT.PNG)

![THPMT2](/Security/InformationSecurity/Image/ch16/THPMT2.PNG)
...
![CSK](/Security/InformationSecurity/Image/ch16/CSK.PNG)
...
![SP](/Security/InformationSecurity/Image/ch16/SP.PNG)

- 서버 SSL Pulse 모니터가 지원하는 가장 취약한 키 교환
- 현재 2048비트의 최소 예상 강도

![KES](/Security/InformationSecurity/Image/ch16/KES.PNG)
