...
![SE](/Security/InformationSecurity/Image/ch01/SE.PNG)

![SE2](/Security/InformationSecurity/Image/ch01/SE2.PNG)
...
![CC](/Security/InformationSecurity/Image/ch01/CC.PNG)

* 숫자로 나타낸 씨저 암호

![MCC](/Security/InformationSecurity/Image/ch01/MCC.PNG)
...
![MCC2](/Security/InformationSecurity/Image/ch01/MCC2.PNG)


* 예시

![EXCC](/Security/InformationSecurity/Image/ch01/EXCC.PNG)
...
![SC](/Security/InformationSecurity/Image/ch01/SC.PNG)
...
![MC](/Security/InformationSecurity/Image/ch01/MC.PNG)
...
![MCalpha](/Security/InformationSecurity/Image/ch01/MCalpha.PNG)
...
![EXVC](/Security/InformationSecurity/Image/ch01/EXVC.PNG)
...
![EXVC2](/Security/InformationSecurity/Image/ch01/EXVC2.PNG)
...
![EXOTP](/Security/InformationSecurity/Image/ch01/EXOTP.PNG)
...
* Rail fence cipher(레일 울타리 암호)
    ...
    * 예시
    ...
    ![RC](/Security/InformationSecurity/Image/ch01/RC.PNG)

* Columnar transposition cipher(열 위치 변환 암호)
    * key의 숫자에 따른 열로 암호를 구성
    * 예시

    ![CTC](/Security/InformationSecurity/Image/ch01/CTC.PNG)
...
![ResolveSecurity](/Security/InformationSecurity/Image/ch01/ResolveSecurity.PNG)
