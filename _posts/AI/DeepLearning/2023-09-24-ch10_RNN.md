---
title: "Chapter 10. 순환 신경망(RNN : Recurrent Neural Networks)"
...
![RNNEX](/AI/DeepLearning/Image/ch10/RNNApplicationDomains.PNG)
...
![window3](/AI/DeepLearning/Image/ch10/SlidingWindowExample.PNG)

2. 전체 데이터를 다음과 같이 크기가 3인 샘플과 정답으로 분리

![res](/AI/DeepLearning/Image/ch10/SequenceSampleSplit.PNG)
...
![samsung](/AI/DeepLearning/Image/ch10/SamsungStockPriceChart.PNG)
...
![RNNStructure](/AI/DeepLearning/Image/ch10/RNNBasicArchitecture.PNG)
...
![RNNS](/AI/DeepLearning/Image/ch10/RNNUnfolding.PNG)

#### 피드-포워드 신경망(Feed-Forward Neural Network)과 RNN

![FFNNRNN](/AI/DeepLearning/Image/ch10/FeedForwardVsRNN.PNG)

- 피드-포워드 신경망 : 여태까지 배웠던 신경망

#### 단어 예측 RNN

![PredictWord](/AI/DeepLearning/Image/ch10/WordPredictionRNN.PNG)
...
![RNNA](/AI/DeepLearning/Image/ch10/RNNActivationTanh.PNG)

![RNNA2](/AI/DeepLearning/Image/ch10/RNNActivationSequence.PNG)
...
![VRNN](/AI/DeepLearning/Image/ch10/VanillaRNNStructure.PNG)
...
![rs](/AI/DeepLearning/Image/ch10/ReturnSequencesOutput.PNG)

##### Ideal RNN Layer

![IRNN](/AI/DeepLearning/Image/ch10/IdealRNNLayer.PNG)
...
![VRNNOP1](/AI/DeepLearning/Image/ch10/VanillaRNNSummary.PNG)

- 파라미터 아웃값 \* (파라미터 아웃값 + 1(차원 수 1) + 1(바이어스)) + 덴스(Dense) 값
- $50 * (50 + 1 + 1) + 51 = 2651$

![VRNNOP](/AI/DeepLearning/Image/ch10/VanillaRNNParameterCount.PNG)
...
![OtO](/AI/DeepLearning/Image/ch10/OneToOneSequence.PNG)
...
![OtM](/AI/DeepLearning/Image/ch10/OneToManySequence.PNG)
...
![MtO](/AI/DeepLearning/Image/ch10/ManyToOneSequence.PNG)
...
![MtM](/AI/DeepLearning/Image/ch10/ManyToManySequence.PNG)

## 4절. 역전파 방향과 그래디언트

#### 순환 신경망 순방향 패스

![RNNPASS](/AI/DeepLearning/Image/ch10/RNNForwardPass.PNG)
...
![RNNINPUT](/AI/DeepLearning/Image/ch10/RNNInputShape.PNG)
...
![BPTT](/AI/DeepLearning/Image/ch10/BackpropagationThroughTime.PNG)
...
![PE](/AI/DeepLearning/Image/ch10/GradientProblemExample.PNG)

##### 그래디언트 소실

![GD](/AI/DeepLearning/Image/ch10/GradientVanishing.PNG)
...
![GI](/AI/DeepLearning/Image/ch10/GradientExplosion.PNG)
...
![GOP](/AI/DeepLearning/Image/ch10/SineWavePredictionLoss.PNG)
...
![GOP2](/AI/DeepLearning/Image/ch10/SineWavePredictionOutput.PNG)
...
![LSTM](/AI/DeepLearning/Image/ch10/LSTMArchitecture.PNG)
...
![Gate](/AI/DeepLearning/Image/ch10/LSTMGateStructure.PNG)

##### 저장 연산

- 셀 상태에 관련있는 새로운 정보 저장

![SM](/AI/DeepLearning/Image/ch10/InputGateOperation.PNG)
...
![DM](/AI/DeepLearning/Image/ch10/ForgetGateOperation.PNG)
...
![UM](/AI/DeepLearning/Image/ch10/CellStateUpdateOperation.PNG)
...
![OM](/AI/DeepLearning/Image/ch10/OutputGateOperation.PNG)

#### 그래디언트 소실 문제 해결

![PS](/AI/DeepLearning/Image/ch10/LSTMGradientSolutionPath.PNG)
...
![Keras1](/AI/DeepLearning/Image/ch10/StockPricePredictionModel.PNG)

![Keras2](/AI/DeepLearning/Image/ch10/StockPricePredictionResults.PNG)
...
![Output1](/AI/DeepLearning/Image/ch10/StockPriceForecastComparison.PNG)
