---
title: "Chapter 9. 영상 인식(ImageRecognition)"
...
![IR](/AI/DeepLearning/Image/ch09/ConvolutionalNeuralNetworks.PNG)

#### 전통적 영상 인식 시스템 구조

![TIR](/AI/DeepLearning/Image/ch09/TraditionalImageRecognitionSystemStructure.PNG)

#### 심층 신경망을 이용한 영상 인식 과정

![DNNIR](/AI/DeepLearning/Image/ch09/DeepNeuralNetworkImageRecognitionProcess.PNG)

#### 영상 인식

- 영상 인식에 가장 많이 사용되는 신경망 : 컨볼루션 신경망(Convolution Neural Network)

![IRCNN](/AI/DeepLearning/Image/ch09/ConvolutionalNeuralNetworkOverview.PNG)

##### 구조

![IRS](/AI/DeepLearning/Image/ch09/CNNStructure.PNG)
...
![IREX](/AI/DeepLearning/Image/ch09/CNNStructureExample.PNG)

#### 데이터 증대(Data augmentation)

- 한정된 데이터에서 여러 가지로 변형된 데이터를 만들어내는 기법

![DA](/AI/DeepLearning/Image/ch09/DataAugmentation.PNG)
...
![OP](/AI/DeepLearning/Image/ch09/OutputPreview.PNG)
...
![WM](/AI/DeepLearning/Image/ch09/WeightManagement.PNG)
...
![TL](/AI/DeepLearning/Image/ch09/TransferLearning.PNG)
...
![KA](/AI/DeepLearning/Image/ch09/KerasApplications.PNG)

##### 프로젝트 적용

![PU](/AI/DeepLearning/Image/ch09/ProjectUsage.PNG)
