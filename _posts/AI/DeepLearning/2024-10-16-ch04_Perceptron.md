---
title: "Chapter 4. 퍼셉트론(Perceptron)"
date: 2024-10-16 23:12:08 +0900
...
![CAI](/AI/DeepLearning/Image/ch04/ComputerVsArtificialIntelligence.PNG)
...
![1234](/AI/DeepLearning/Image/ch04/LogicOperationsWithNeurons.PNG)
...
![PCT2](/AI/DeepLearning/Image/ch04/PerceptronStructure.PNG)
...
![PCT3](/AI/DeepLearning/Image/ch04/PerceptronActivation.PNG)

- 임계값
  - 정해진 한계
  - 세타 기호로 표현

![theta](/AI/DeepLearning/Image/ch04/ThresholdValue.PNG)

#### 퍼셉트론의 논리 연산

![PCTL](/AI/DeepLearning/Image/ch04/PerceptronLogicOperation.PNG)

![PCTL2](/AI/DeepLearning/Image/ch04/PerceptronLogicOperation2.PNG)

## 2절. 활성화 함수

#### 계단 함수

![USF](/AI/DeepLearning/Image/ch04/UnitStepFunction.PNG)

#### 퍼셉트론 학습 알고리즘

- 학습 : 신경망이 스스로 가중치를 자동 설정하는 알고리즘이 필요하며 퍼셉트론에서도 존재

![PCTLA](/AI/DeepLearning/Image/ch04/PerceptronLearningAlgorithm.PNG)

![PCTLA2](/AI/DeepLearning/Image/ch04/PerceptronLearningAlgorithm2.PNG)
...
![OR](/AI/DeepLearning/Image/ch04/ORGate.PNG)
...
![NAND](/AI/DeepLearning/Image/ch04/NANDGate.PNG)
...
![NLinear2](/AI/DeepLearning/Image/ch04/NonlinearVsLinearRegion.PNG)
...
![BL](/AI/DeepLearning/Image/ch04/BasicLogicGateCombination.PNG)
...
![MLP2](/AI/DeepLearning/Image/ch04/SingleAndMultiLayerPerceptron.PNG)
...
![DNN](/AI/DeepLearning/Image/ch04/DeepNeuralNetwork.PNG)

#### 선형 분류 가능 문제

- 패턴 인식 측면에서 보면 퍼셉트론은 직선을 이용하여 입력 패턴을 분류하는 선형 분류자(Linear Classifier)의 일종

![LC](/AI/DeepLearning/Image/ch04/LinearClassification.PNG)

- 1개의 레이어로 구성된 퍼셉트론은 XOR 문제를 학습할 수 없음

![MLPXOR](/AI/DeepLearning/Image/ch04/MultiLayerPerceptronXORProblem.PNG)
