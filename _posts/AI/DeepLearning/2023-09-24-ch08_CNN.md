---
title: "Chapter 8. 컨볼루션 신경망(CNN : Convolution Neural Networks)"
...
![CNN](/AI/DeepLearning/Image/ch08/ConvolutionalNeuralNetworkBasic.PNG)

##### 네오코그니트론(Neocognitron)

- 1980년 후쿠시마에 의해 소개된 신경망 구조

![Neo](/AI/DeepLearning/Image/ch08/NeocognitronArchitecture.PNG)
...
![CNNS](/AI/DeepLearning/Image/ch08/CNNStructureOverview.PNG)
...
![CA](/AI/DeepLearning/Image/ch08/ConvolutionOperationBasic.PNG)

![CA2](/AI/DeepLearning/Image/ch08/ConvolutionOperationExample.PNG)

##### 컨볼루션의 구체적 예시

![CAex1](/AI/DeepLearning/Image/ch08/ConvolutionExample1.PNG)

![CAex2](/AI/DeepLearning/Image/ch08/ConvolutionExample2.PNG)

##### 특징맵(Feature Map)

![FM](/AI/DeepLearning/Image/ch08/FeatureMapOutput.PNG)

- 컨볼루션을 수행한 결과

##### 컨볼루션 신경망

![CP1](/AI/DeepLearning/Image/ch08/CNNKernelApplication.PNG)
...
![CL](/AI/DeepLearning/Image/ch08/ConvolutionLayerMultipleFilters.PNG)
...
![Stride](/AI/DeepLearning/Image/ch08/StrideMovement.PNG)

#### 패딩(padding)

- 이미지의 가장자리 처리 기법

![Padding](/AI/DeepLearning/Image/ch08/PaddingTechnique.PNG)

##### Valid

- 커널을 입력 이미지 안에서만 움직임

![PV](/AI/DeepLearning/Image/ch08/PaddingValid.PNG)

##### Same

- 입력 이미지의 주변을 특정값(0 OR 이웃값)으로 채움

![PS](/AI/DeepLearning/Image/ch08/PaddingSame.PNG)

#### 필터가 다수일 때의 컨볼루션 레이어

![CL2](/AI/DeepLearning/Image/ch08/MultipleFiltersConvolution1.PNG)

![CL3](/AI/DeepLearning/Image/ch08/MultipleFiltersConvolution2.PNG)
...
![PL](/AI/DeepLearning/Image/ch08/PoolingSubsampling.PNG)
...
![PT](/AI/DeepLearning/Image/ch08/PoolingTypes.PNG)

##### 최대 풀링

- 컨볼루션처럼 윈도우를 움직여 가장 큰 값만 출력하는 연산

![MP](/AI/DeepLearning/Image/ch08/MaxPoolingOperation.PNG)

#### 컨볼루션 신경망 해석

![CLR](/AI/DeepLearning/Image/ch08/CNNInterpretation.PNG)
...
![CNNS2](/AI/DeepLearning/Image/ch08/CNNStructureDetailedFlow.PNG)
...
![CNNS3](/AI/DeepLearning/Image/ch08/CNNChannelsLayer1Convolution.PNG)
...
![CNNS4](/AI/DeepLearning/Image/ch08/CNNChannelsLayer1Pooling.PNG)

- 합성곱 이후 풀링으로 이미지의 크기를 절반으로 줄임($12 × 12 × n1$)

##### 3) n2 channels

![CNNS5](/AI/DeepLearning/Image/ch08/CNNChannelsLayer2Convolution.PNG)
...
![CNNS6](/AI/DeepLearning/Image/ch08/CNNChannelsLayer2Pooling.PNG)
...
![CNNS7](/AI/DeepLearning/Image/ch08/CNNFlattenedTensor.PNG)

- 4 × 4 × $n2$의 텐서를 reshape(1, 16n2)하면 길쭉 한 벡터(1 × 16 × n2)생성 이 과정을 flatten 과정 (텐서를 벡터로 쭉 펴는 것)

##### 6) ReLU Activation

![ReLUA](/AI/DeepLearning/Image/ch08/ReLUActivationMLP.PNG)
...
![OP](/AI/DeepLearning/Image/ch08/CNNOutputLayer.PNG)
...
![AN](/AI/DeepLearning/Image/ch08/AlexNetArchitecture.PNG)
...
![KCNN](/AI/DeepLearning/Image/ch08/KerasConvolutionalNeuralNetworkImplementation.PNG)
...
![MP2](/AI/DeepLearning/Image/ch08/MaxPooling2DOutput.PNG)
...
![MNISTP](/AI/DeepLearning/Image/ch08/MNISTOutputProcess.PNG)
