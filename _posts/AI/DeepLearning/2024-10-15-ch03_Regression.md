---
title: "Chapter 3. 회귀(Regression)"
date: 2024-10-15 23:38:37 +0900
...
![RC](/AI/DeepLearning/Image/ch03/RegressionVsClassification.PNG)
...
![RCT](/AI/DeepLearning/Image/ch03/RegressionLineEquation.PNG)
...
![MLP](/AI/DeepLearning/Image/ch03/MultipleLinearRegression.PNG)
...
![RES](/AI/DeepLearning/Image/ch03/RegressionScatterPlot.PNG)

- 최선의 것은 데이터 간의 오차가 작은 경우

![RES2](/AI/DeepLearning/Image/ch03/RegressionFitComparison.PNG)
...
![LF](/AI/DeepLearning/Image/ch03/LossFunctionFormula.PNG)

- 선형 회귀 선과의 차이가 큰 경우 손실이 큼
- 선형 회귀 선과의 차이가 작은 경우 손실이 작음

![LF2](/AI/DeepLearning/Image/ch03/LossFunctionVisualization.PNG)
...
![MinLR](/AI/DeepLearning/Image/ch03/LinearRegressionMinimization.PNG)
...
![GDM](/AI/DeepLearning/Image/ch03/GradientDescentMethod.PNG)
...
![GDM2](/AI/DeepLearning/Image/ch03/GradientDescentPlot.PNG)

#### 학습률

![LP](/AI/DeepLearning/Image/ch03/LearningRate.PNG)

#### 지역 최솟값 문제

![LM](/AI/DeepLearning/Image/ch03/LocalMinimumProblem.PNG)

#### 선형 회귀에서의 경사 하강법

![LRGDM](/AI/DeepLearning/Image/ch03/LinearRegressionGradientDescent.PNG)
...
![RES3](/AI/DeepLearning/Image/ch03/HeightWeightData.PNG)
...
![RES4](/AI/DeepLearning/Image/ch03/HeightWeightResult.PNG)
...
![RES6](/AI/DeepLearning/Image/ch03/DiabetesRegression.PNG)
...
![OU](/AI/DeepLearning/Image/ch03/OverfittingUnderfittingComparison.PNG)
...
![set12](/AI/DeepLearning/Image/ch03/PolynomialFitDegrees.PNG)

- 그래프에서 보는 과잉 적합과 과소 적합의 비교

![COU](/AI/DeepLearning/Image/ch03/CurveOverfittingUnderfitting.PNG)
...
![Logistic](/AI/DeepLearning/Image/ch03/LogisticRegressionScatterPlot.PNG)

- 직선의 중간쯤을 넘어가면 불합격
- 직선의 중간쯤을 넘어가면 합격

![Logistic2](/AI/DeepLearning/Image/ch03/LogisticRegressionSlope.PNG)

- 데이터($y$)와 직선($^y$)간의 평균을 최소화하기 위한 직선의 기울기 움직임

![Logistic3](/AI/DeepLearning/Image/ch03/LogisticRegressionThreshold.PNG)
...
![LL](/AI/DeepLearning/Image/ch03/LinearVsLogisticRegression.PNG)

#### 시그모이드 함수(Sigmoid)

![Sig](/AI/DeepLearning/Image/ch03/SigmoidFunction.PNG)
...
![Sig2](/AI/DeepLearning/Image/ch03/SigmoidCostFunction.PNG)
...
![CE](/AI/DeepLearning/Image/ch03/CrossEntropyLoss.PNG)

![CEL](/AI/DeepLearning/Image/ch03/CrossEntropyLossFormula.PNG)
