---
title: "chapter 4. 스택(Stack)"
date: 2023-09-19 22:01:40 +0900
categories: [ComputerScience, DataStructure]
---

#### 스택

![stack](/ComputerScience/DataStructure/Image/ch04/Stack.PNG)
...
![stack2](/ComputerScience/DataStructure/Image/ch04/Stack2.PNG)
...
![stackfunction](/ComputerScience/DataStructure/Image/ch04/StackFunction.PNG)

#### 스택의 활용
* 일반적인 가상 메모리 구조

![stackstructure](/ComputerScience/DataStructure/Image/ch04/StackStructure.PNG)
...
![stackir](/ComputerScience/DataStructure/Image/ch04/StackInsertRemove.PNG)

#### 스택의 삽입 : push(item)
* 스택에 데이터를 삽입하면 맨 윗부분에 항목이 추가

![push](/ComputerScience/DataStructure/Image/ch04/Push.PNG)

#### 스택의 삭제 : pop()
* 스택에 데이터를 삭제하면 맷 윗부분의 항목이 삭제

![pop](/ComputerScience/DataStructure/Image/ch04/Pop.PNG)
