...
![queue](/ComputerScience/DataStructure/Image/ch05/Queue.PNG)
...
![queue2](/ComputerScience/DataStructure/Image/ch05/Queue2.PNG)

#### 큐의 삽입
* 큐에 값을 삽입하면 tail(끝)부분에 값이 삽입

![enqueue](/ComputerScience/DataStructure/Image/ch05/Enqueue.PNG)

#### 큐의 삭제
* 큐에 값을 삭제하면 front(처음)부분에 값이 삽입

![dequeue](/ComputerScience/DataStructure/Image/ch05/Dequeue.PNG)
