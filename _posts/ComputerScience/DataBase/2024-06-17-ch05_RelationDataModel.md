...
![RelationStructure](/ComputerScience/DataBase/Image/ch05/RelationStructure.PNG){ width="100%" }
...
| ![DataTableStructure](/ComputerScience/DataBase/Image/ch05/DataTableStructure.PNG) | 릴레이션 내 데이터들의 관계 |
| --------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |

| ![RelationshipBetweenRelations](/ComputerScience/DataBase/Image/ch05/RelationshipBetweenRelations.PNG){ width="70%" } | 릴레이션 간 관계 |
| -------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
...
![RelationStructureExample](/ComputerScience/DataBase/Image/ch05/RelationStructureExample.PNG){ width="100%" }
...
![MultiValueAttribute](/ComputerScience/DataBase/Image/ch05/MultiValueAttribute.PNG){ width="80%" }
...
![DuplicateTupleExample](/ComputerScience/DataBase/Image/ch05/DuplicateTupleExample.PNG){ width="80%" }
...
![DatabaseSchemaAndInstance](/ComputerScience/DataBase/Image/ch05/DatabaseSchemaAndInstance.PNG){ width="100%" }
...
![KeyTypes](/ComputerScience/DataBase/Image/ch05/KeyTypes.PNG){ width="80%" }

### 데이터베이스 릴레이션 예시

![DatabaseRelationExample](/ComputerScience/DataBase/Image/ch05/DatabaseRelationExample.PNG){ width="100%" }
...
![ForeignKeyExample](/ComputerScience/DataBase/Image/ch05/ForeignKeyExample.PNG){ width="80%" }
...
| ![ForeignKeyMultiple](/ComputerScience/DataBase/Image/ch05/ForeignKeyMultiple.PNG) | - 하나의 릴레이션에 여러 외래키 존재 가능<br>- 외래키를 기본키로 사용 가능 |
| --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |

| ![ForeignKeySelfReference](/ComputerScience/DataBase/Image/ch05/ForeignKeySelfReference.PNG) | - 같은 릴레이션의 기본키를 참조하는 외래키 정의 가능<br>- 외래키는 NULL 값 보유 가능 |
| --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |

### 릴레이션 간 참조 관계

![RelationReferenceStructure](/ComputerScience/DataBase/Image/ch05/RelationReferenceStructure.PNG){ width="80%" }
...
![IntegrityConstraintTypes](/ComputerScience/DataBase/Image/ch05/IntegrityConstraintTypes.PNG){ width="80%" }
...
![EntityIntegrityConstraint](/ComputerScience/DataBase/Image/ch05/EntityIntegrityConstraint.PNG){ width="80%" }
...
![ReferentialIntegrityExample](/ComputerScience/DataBase/Image/ch05/ReferentialIntegrityExample.PNG){ width="80%" }

### 참조 무결성 제약조건 삽입 / 수정 / 삭제

![ReferentialIntegrityOperations](/ComputerScience/DataBase/Image/ch05/ReferentialIntegrityOperations.PNG){ width="80%" }
...
![ReferentialIntegrityOptions](/ComputerScience/DataBase/Image/ch05/ReferentialIntegrityOptions.PNG){ width="80%" }
