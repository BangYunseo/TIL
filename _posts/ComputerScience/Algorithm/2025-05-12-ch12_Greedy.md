---
title: "Chapter 12. Greedy(그리디 알고리즘)"
...
![GreedyAlgorithm](/ComputerScience/Algorithm/Image/ch12/GreedyAlgorithm.PNG){ width="60%" }
...
![BinaryTreePathSum](/ComputerScience/Algorithm/Image/ch12/BinaryTreePathSum.PNG){ width="40%" }
...
![CoinChangeCounterExample](/ComputerScience/Algorithm/Image/ch12/CoinChangeCounterExample.PNG)
...
![CoinChangeOptimal](/ComputerScience/Algorithm/Image/ch12/CoinChangeOptimal.PNG)

#### 최소 신장 트리를 위한 Prim 알고리즘과 Kruskal 알고리즘 구조

![PrimMST](/ComputerScience/Algorithm/Image/ch12/PrimMST.PNG)
...
![HuffmanCodingTree](/ComputerScience/Algorithm/Image/ch12/HuffmanCodingTree.PNG)
...
![HuffmanEncodingExample](/ComputerScience/Algorithm/Image/ch12/HuffmanEncodingExample.PNG)

- 어떤 Code도 다른 코드의 접두어가 되지 않음

#### 호프만 코딩 예시 (2)

![HuffmanTreeConstruction](/ComputerScience/Algorithm/Image/ch12/HuffmanTreeConstruction.PNG)
